...
In the Dashboard (New) top menu bar, click the filter icon to show the variables option. The filter icon allows you to toggle if the variables option is displayed or hidden.
...
1. In the Dashboard (New) top menu bar, click the filter icon to show the variables option. The filter icon allows you to toggle if the variables option is displayed or hidden.
...
This task shows you how to modify an existing template variable in a Dashboard (New) so you can rescope your data on the fly. This is helpful for troubleshooting a problem to a fast resolution to the root cause.
...
This task shows you how you can easily delete a template variable from Dashboard (New).
